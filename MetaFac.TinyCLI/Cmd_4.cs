...
namespace MetaFac.TinyCLI
{
    public sealed class Cmd<TArg1, TArg2, TArg3, TArg4, TResult> : CmdBase<TResult>
    {
        ...
        private readonly Func<TArg1, TArg2, TArg3, TArg4, ValueTask<TResult>> _actionMin;
        private readonly Func<TArg1, TArg2, TArg3, TArg4, OtherArgs, ValueTask<TResult>> _actionExt;
        ...
        protected override async ValueTask<int> OnRun(InternalLogger? logger, string[] args)
        {
            return await RunAction(logger, args, Name, Help, async () =>
            {
                ...
                {
                    return await _actionExt(arg1, arg2, arg3, arg4, new OtherArgs(remaining4));
                }
                else
                {
                    return await _actionMin(arg1, arg2, arg3, arg4);
                }
            },
